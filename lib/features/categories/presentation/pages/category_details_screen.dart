                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Skeleton(height: 110, width: 130, borderRadius: 10),
                            const SizedBox(width: 16),
                            Skeleton(height: 110, width: 200, borderRadius: 10),
                            const SizedBox(width: 16),
                            Skeleton(height: 110, width: 100, borderRadius: 10),
                            const SizedBox(width: 16),
                            Skeleton(height: 110, width: 150, borderRadius: 10),
                          ],
                        ),
                      ),
                    ),
