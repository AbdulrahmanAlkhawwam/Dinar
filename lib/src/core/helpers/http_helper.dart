...
//     Map<String, String>? headers,
//   }) =>
//       _sendRequest(_Verb.get, path, queryParameters: queryParameters, headers: headers);
//
//   @override
//   Future post(
//     String path, {
...
//     Map<String, String>? headers,
//   }) =>
//       _sendRequest(_Verb.put, path, queryParameters: queryParameters, body: body, headers: headers);
//
//   @override
//   Future patch(
//     String path, {
...
//         jsonDecode(response.body)["message"]?.toString() ?? response.statusCode.toString(),
...
//       final refreshToken = storage.getString(refreshTokenKey);
//       var uri = Uri.https(host, "$basePath/refresh-token");
//       var headers = {"Authorization": "Bearer $refreshToken"};
//       dev.log(uri.toString(), name: "HttpHelper.refreshToken");
//       dev.log(headers.toString(), name: "HttpHelper.refreshToken.headers");
//       final response = await client.put(uri, headers: headers);
//       dev.log(
//         response.body.substring(0, math.min(response.body.length, 100)),
//         name: "HttpHelper.refreshToken.response",
//       );
//       if (response.statusCode == 401) {
//         throw AuthorizationException("Expired refresh token", false);
//       } else if (response.statusCode ~/ 100 != 2) {
...
//       await storage.setString(accessTokenKey, newAccessToken);
//       await storage.setString(refreshTokenKey, newRefreshToken);
//     });
//   }
// }
