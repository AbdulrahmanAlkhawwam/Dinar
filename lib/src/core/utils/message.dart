...
//   final bool readable;
//
//   Message(this.value, {this.code, this.platformCode, this.readable = false});
//
//   factory Message.fromFailure(Failure failure) {
//     if (failure is ServerFailure) {
//       return Message(failure.message, code: failure.statusCode);
//     } else if (failure is NetworkFailure) {
//       return Message(LocaleKeys.error_messages_no_internet_connection, readable: true);
...
//       case "7":
//         return LocaleKeys.error_messages_cannot_restore_subscription_error_7.tr();
//       case "10":
//         return LocaleKeys.error_messages_network_error_retry.tr();
//       case "15":
//         return LocaleKeys.error_messages_subscription_pending_wait.tr();
//       default:
//         return LocaleKeys.error_messages_operation_failed_with_code_args.tr(args: [platformCode!]);
//     }
//   }
//
...
//       return LocaleKeys.error_messages_data_receiving_error_contact_support.tr();
